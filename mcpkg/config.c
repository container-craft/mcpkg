...
mcpkg_error_types set_global_mc_base(const char *mc_base)
{
    ...
    mcpkg_error_types rc = mcpkg_global_mc_base(mc_base);
...
mcpkg_error_types set_global_mc_loader(const char *mc_loader)
{
    ...
    mcpkg_error_types rc = mcpkg_global_mc_loader(mc_loader);
    if (rc == MCPKG_ERROR_SUCCESS) {
...
mcpkg_error_types set_global_mc_version(const char *mc_version)
{
    ...
    mcpkg_error_types rc = mcpkg_global_mc_version(mc_version);
    if (rc == MCPKG_ERROR_SUCCESS) {
