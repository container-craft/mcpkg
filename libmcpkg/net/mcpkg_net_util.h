...
MCPKG_API int  mcpkg_net_buf_append(struct McPkgNetBuf *b, const void *data, size_t n);
MCPKG_API void mcpkg_net_buf_reset(struct McPkgNetBuf *b); /* len = 0, keep cap */
