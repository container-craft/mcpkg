...
MCPKG_STATIC_ASSERT(
    sizeof(crypto_hash_sha256_state) <= sizeof(((struct mcpkg_crypto_hash_ctx *)0)->_s256),
    "s256 storage too small");
MCPKG_STATIC_ASSERT(
    sizeof(crypto_hash_sha512_state) <= sizeof(((struct mcpkg_crypto_hash_ctx *)0)->_s512),
    "s512 storage too small");
MCPKG_STATIC_ASSERT(
    sizeof(crypto_generichash_state) <= sizeof(((struct mcpkg_crypto_hash_ctx *)0)->_b2b),
