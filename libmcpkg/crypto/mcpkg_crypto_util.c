...
{
    switch (err) {
    case MCPKG_CRYPTO_OK:              return "ok";
    case MCPKG_CRYPTO_ERR_IO:          return "io";
    case MCPKG_CRYPTO_ERR_INIT:        return "init";
    case MCPKG_CRYPTO_ERR_ARG:         return "arg";
    case MCPKG_CRYPTO_ERR_NOMEM:       return "nomem";
    case MCPKG_CRYPTO_ERR_PARSE:       return "parse";
    case MCPKG_CRYPTO_ERR_VERIFY:      return "verify";
    case MCPKG_CRYPTO_ERR_UNSUPPORTED: return "unsupported";
    case MCPKG_CRYPTO_ERR_MISMATCH:    return "mismatch";
