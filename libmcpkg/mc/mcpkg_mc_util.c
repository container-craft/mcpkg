...
{
	switch (e) {
		case MCPKG_MP_NO_ERROR:
			return MCPKG_MC_NO_ERROR;
		case MCPKG_MP_ERR_INVALID_ARG:
			return MCPKG_MC_ERR_INVALID_ARG;
		case MCPKG_MP_ERR_PARSE:
			return MCPKG_MC_ERR_PARSE;
		case MCPKG_MP_ERR_NO_MEMORY:
			return MCPKG_MC_ERR_NO_MEMORY;
		case MCPKG_MP_ERR_IO:
			return MCPKG_MC_ERR_IO;
		default:
			return MCPKG_MC_ERR_PARSE;
	}
}
