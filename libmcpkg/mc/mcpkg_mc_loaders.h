...
// === API ===
MCPKG_API int  mcpkg_mc_loader_new(struct McPkgMcLoader **outp,
                                   MCPKG_MC_LOADERS id);
...
MCPKG_API void mcpkg_mc_loader_set_base_url(struct McPkgMcLoader *l,
                const char *base_url);
MCPKG_API int  mcpkg_mc_loader_set_base_url_dup(struct McPkgMcLoader *l,
                const char *base_url);
MCPKG_API void mcpkg_mc_loader_set_online(struct McPkgMcLoader *l, int online);
MCPKG_API void mcpkg_mc_loader_set_ops(struct McPkgMcLoader *l,
                                       const struct McPkgMcLoaderOps *ops);
