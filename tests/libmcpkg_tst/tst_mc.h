...
static void test_loaders_message_pack(void)
{
    ...
    CHECK_OK_MC("set_base_url_dup", mcpkg_mc_loader_set_base_url_dup(l, "https://meta.fabricmc.net"));
...
static void test_versions_message_pack(void)
{
    ...
    void *buf = NULL;
    size_t len = 0;
    struct McPkgMCVersion out = mcpkg_mc_version_family_make(MCPKG_MC_CODE_NAME_UNKNOWN);
...
static void test_mc(void)
{
    ...
    // latest lookup
    rc = mcpkg_mc_latest_for_codename(mc, MCPKG_MC_CODE_NAME_TRICKY_TRIALS, &latest);
