...
static void test_strlist_basic(void)
{
    ...
    CHECK_EQ_INT("mcpkg_stringlist_index_of beta", mcpkg_stringlist_index_of(sl, "beta"), 1);

    CHECK_OKC("ADD AT 1 Str", mcpkg_stringlist_add(sl, 1, "middle"));
    CHECK_EQ_INT("mcpkg_stringlist_index_of middle:", mcpkg_stringlist_index_of(sl, "middle"), 1);
...
static void test_map_basic(void)
{
    ...
    v = 25; CHECK_OKC("update k2=25", mcpkg_map_set(m, "k2", &v));
